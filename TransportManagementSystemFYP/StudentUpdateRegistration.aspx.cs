...
{
    public partial class StudentUpdateRegistration : System.Web.UI.Page
    {
        ...
        protected void GridView_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string name = (GridView.Rows[e.RowIndex].FindControl("txt_Name") as TextBox).Text;
            string cnic = (GridView.Rows[e.RowIndex].FindControl("txt_CNIC") as TextBox).Text;
            string address = (GridView.Rows[e.RowIndex].FindControl("txt_Address") as TextBox).Text;
            string number = (GridView.Rows[e.RowIndex].FindControl("txt_NO") as TextBox).Text;
            ...
            using (SqlConnection con = new SqlConnection(Dstring))
            {
                string query = "UPDATE StudentRegistration set UniID=@id,Name=@name,CNIC=@cnic,Address=@address,PhoneNumber=@no,city=@city,Route=@route,Stop=@stop WHERE UniID = @id";
                SqlCommand cmd = new SqlCommand(query, con);
